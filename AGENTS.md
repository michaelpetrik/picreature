...
This project is indexed by GitNexus as **picreature** (329 symbols, 720 relationships, 25 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
